        ...
        <section className="site-panel" aria-labelledby={`${sitePanel}-title`}>
          ...
          {sitePanel === "about" ? (
            ...
            <article className="article">
              ...
              <figure className="headline-chart" aria-labelledby="headline-chart-title">
                <figcaption><span id="headline-chart-title">Reported overall vacancy</span><small>Q2 2026 · firm-reported figures · not like-for-like</small></figcaption>
                <div className="headline-chart-scale"><span>0%</span><span>10%</span><span>20%</span><span>25%</span></div>
                <div className="headline-bar"><b>CBRE</b><div><i style={{ width: "48.8%" }} /></div><span>12.2%</span></div>
                <div className="headline-bar"><b>Colliers</b><div><i style={{ width: "71.9%" }} /></div><span>18.0%</span></div>
                <div className="headline-bar"><b>C&amp;W</b><div><i style={{ width: "51.6%" }} /></div><span>12.9%</span></div>
                <div className="headline-bar"><b>JLL</b><div><i style={{ width: "80.8%" }} /></div><span>20.2%</span></div>
                <p>Range: 8.0 percentage points. This spread is a methodology signal as much as a market signal.</p>
              </figure>
              ...
              <section className="reconciliation" aria-labelledby="reconciliation-title">
                <div><p className="article-eyebrow">WHY THE SAME DEAL CAN LAND IN DIFFERENT QUARTERS</p><h3 id="reconciliation-title">A simple timing reconciliation</h3></div>
                <div className="reconciliation-lanes"><div><b>1</b><span>Lease execution</span><small>CBRE recognizes the committed demand event when the lease is signed.</small></div><div><b>2</b><span>Construction, delivery, or build-out</span><small>Preleased space is recognized by CBRE in the quarter the building delivers.</small></div><div><b>3</b><span>Tenant move-in</span><small>C&amp;W recognizes the occupancy change when space is physically occupied.</small></div></div>
                <p className="reconciliation-note">Implication: one tenant decision can strengthen CBRE's absorption before it appears in a physical-occupancy series. During a development cycle, the gap may widen; after occupancies catch up, it can narrow.</p>
              </section>
              <h2>What the headline statistics do—and do not—say</h2>
              <p>All four reports point to improved demand momentum in Q2, but they frame the magnitude differently. CBRE reported 1.0 million square feet of quarterly net absorption and a 12.2% vacancy rate. Colliers reported 1.03 million square feet of quarterly absorption, 17.97% vacancy, and 81.8 million square feet of inventory. C&amp;W reported 105.3 million square feet of inventory, a 12.9% overall vacancy rate, and 1.32 million square feet of year-to-date net absorption. JLL reported 1.2 million square feet of quarterly absorption and 20.2% total vacancy.</p>
              <p>These figures support a directional conclusion—activity improved and vacancy declined in the firms' respective series—but not a single definitive estimate of Charleston vacancy. The reported 8.0-point vacancy range is too wide to explain away as rounding. It signals that the denominator, the treatment of vacant or available space, and the timing of occupancy events matter.</p>
              ...
              <div className="comparison-ledger" aria-label="Sources of reporting divergence"><div><span>DENOMINATOR</span><b>Which buildings are included?</b><p>Size thresholds, submarket boundaries, property types, and reclassifications change total inventory.</p></div><div><span>NUMERATOR</span><b>What is considered vacant?</b><p>Space available now, space available soon, and leased-but-unoccupied space are not the same thing.</p></div><div><span>CLOCK</span><b>When does demand count?</b><p>Lease signing, delivery, and move-in are separate events that can occur in different quarters.</p></div></div>
              <h2>Inventory scope can change the market story</h2>
              <p>Colliers' 20,000-square-foot floor excludes smaller industrial buildings that CBRE's 10,000-square-foot threshold can include. That is especially relevant in smaller-bay and flex segments, where a large count of modestly sized assets can behave differently from bulk warehouse stock. Colliers also explicitly identifies flex/R&amp;D as requiring at least 30% office area, while other survey frameworks may distribute mixed-use industrial product differently.</p>
              <p>C&amp;W's 105.3 million-square-foot inventory is 28.7% larger than Colliers' 81.8 million-square-foot reported inventory. That difference does not establish that either is incorrect; it demonstrates why inventory must be reconciled before comparing vacancy rates. A market rate is a ratio, and changing the set of buildings changes both the numerator and denominator.</p>
              <h2>Availability is a forward-looking complement to vacancy</h2>
              <p>CBRE defines vacant space as space occupiable within 30 days, while its availability measure can include occupied or vacant space ready within six months. That makes availability a broader view of near-term tenant choice. C&amp;W separately notes that its vacant-available measure excludes leased-but-unoccupied space. In practical terms, vacancy answers “what is empty?” while availability is closer to “what could a tenant realistically pursue?”—but each firm’s implementation still needs to be read in context.</p>
              <h2>How to make a responsible comparison</h2>
              <ol className="comparison-steps"><li><b>Start within one provider’s series.</b> Use quarter-over-quarter or year-over-year movement from the same survey to understand its internal trend.</li><li><b>Reconcile the universe.</b> Check size threshold, geography, property categories, and whether the series includes specialized product.</li><li><b>Align the clock.</b> Confirm whether absorption represents signed leases, delivery-quarter preleases, or physical occupancies.</li><li><b>Separate vacancy from availability.</b> Do not substitute one for the other without reading the definitions.</li><li><b>Label the conclusion.</b> Say whether a comparison is directional, like-for-like, or not comparable with the disclosures available.</li></ol>
